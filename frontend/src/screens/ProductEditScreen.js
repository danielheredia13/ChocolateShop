...
const ProductEditScreen = () => {
    ...
    const { loading: loadingUpdate, success, error: errorUpdate, product: updatedProduct } = productUpdate
  ...
  return (
    <FormContainer>
        <h2>Edit Product</h2>
        <Link to="/admin/productlist" className='btn btn-sm btn-dark mb-3 rounded' >Go Back</Link>
